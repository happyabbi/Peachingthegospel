 ...
 *******************************************************************************/
package org.church.peachingthegospel.app.widget;
...
import org.church.peachingthegospel.app.UILApplication;
...
public class UILWidgetProvider extends AppWidgetProvider {
	...
	static void updateAppWidget(Context context, final AppWidgetManager appWidgetManager, final int appWidgetId) {
		...
		ImageLoader.getInstance()
				.loadImage(Constants.HUMANLIFE_TW_IMAGES[0], minImageSize, displayOptions, new SimpleImageLoadingListener() {
			@Override
		...
		ImageLoader.getInstance()
				.loadImage(Constants.HUMANLIFE_TW_IMAGES[1], minImageSize, displayOptions, new SimpleImageLoadingListener() {
			@Override
			public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
